...
const Servicios = () => {
    ...
    const handleAgregarServicio = async () => {
        try {
            const response = await api.post('/crear_servicio', {
                nombre,
                descripcion,
                precio
            });
    ...
    const handleEliminarServicio = async () => {
        try {
            ...
            const response = await api.delete(`/eliminar_servicio/${id_servicio}`);
            console.log(response.data);
    ...
    const handleModificarServicio = async () => {
        try {
            const response = await api.put(`/actualizar_servicio/${servicioSeleccionado.id_servicio}`, {
                nombre,
                descripcion,
                precio
            });
